...
namespace Gym_Management_System
{
    ...
    {
        private string staffmem_qry = "SELECT Id,NIC,Name,Job_Type,Professional_qualifications,DOB,Joined_date,Address_living,Mobile_no_public,Mobile_no_private,Home_address,Emergency_Contact_Name,Emergency_Contact_Number,Email,Gender FROM Staff_Member";
